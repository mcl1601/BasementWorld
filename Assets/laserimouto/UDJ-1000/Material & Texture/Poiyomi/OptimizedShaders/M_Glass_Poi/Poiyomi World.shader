Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/7cb89f0f9bcbb2e459aa09b7fbbe6622"
{
	Properties
	{
 ...
 #define PROP_CLIPPINGMASK 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.7921569).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.7921569).a;
