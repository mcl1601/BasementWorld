Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/4fd0ec0c10e4b984ba89887cb770b5d0"
{
	Properties
	{
 ...
 #define PROP_MOCHIEMETALLICMAPS 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, float(1.274), float(0))) * lerp(1, poiLight.attenuation, poiLight.attenuationStrength);
				float3 indirectColor = ShadeSH9_wrapped(poiMesh.normals[float(0)], float(1.274)) * poiLight.occlusion;
