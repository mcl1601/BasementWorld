Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro World/9d64cb6f03c0321419dc1f891ef3d407"
{
	Properties
	{
 ...
 #define PROP_CLIPPINGMASK 
			...
			{
				float smoothness = float(0.967);
				float smoothness2 = float(1);
				float metallic = float(0.993);
 ...
 #define PROP_CLIPPINGMASK 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(4) == 4)
				{
					poiFragData.alpha = saturate(poiFragData.alpha * float(21.6));
				}
